const mostRecentOrderByItemAndSupplierQuery = `SELECT base_orders.order_id, supplier.supplier_code, base_orders.item_num, base_orders.item_name, base_orders.unit_price, base_orders.qty, base_orders.unit, base_orders.order_date, base_orders.promise_date
FROM supplier
INNER JOIN (
...
FROM orders WHERE supplier_id = $2 AND item_id = $1
) AS supplier_orders
...
ORDER BY base_orders.order_date DESC, base_orders.order_id DESC LIMIT 2;`;
